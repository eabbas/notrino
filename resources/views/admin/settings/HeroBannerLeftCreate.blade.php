...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="max-w-2xl mx-auto">
        <div class="bg-white rounded-3xl shadow-2xl overflow-hidden border border-orange-100">
            ...
            <form action="{{ route('setting.upsertHeroBannerLeft') }}" method="post" enctype="multipart/form-data" class="p-8">
                @csrf
                ...
                <div class="mb-8">
                    ...
                    <div class="space-y-4">
                        <!-- label با for="heroBanner" دقیقا مثل کد اصلی -->
                        ...
                        <div class="relative group">
                            <div class="border-3 border-dashed border-orange-200 rounded-2xl p-8 text-center hover:border-orange-400 transition bg-orange-50/30 group">
                                <!-- input با name="heroBannerLeft" دقیقا مثل کد اصلی -->
                                <input type="file" name="heroBannerLeft" id="heroBanner" accept="image/*" required
