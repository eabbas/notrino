                ...
                <div class="w-2/3 bg-white h-full p-2 flex flex-col justify-between">
                    <div>
                        ...
                        <div class="overflow-y-auto [&::-webkit-scrollbar]:hidden h-[calc(100vh-134px)]">
                            ...
                            @if (Auth::user()->role[0]->title == 'ادمین')
                                <div class="pt-3">
                                   <h3 class="text-md font-semibold text-gray-800 mb-1.5">فوتر</h3>
                                    <ul class="pr-3.5">
                                        <li>
                                            <a href="{{ route('footer.footerCreate') }}"
                                                class="block text-gray-700 py-2 text-md">
                                                ایجاد ستون های فوتر
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ route('express.expressCreate') }}"
                                                class="block text-gray-700 py-2 text-md">
                                                ایجاد بنر های فوتر 
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ route('setting.createDescription') }}"
                                                class="block text-gray-700 py-2 text-md">
                                                توضیحات فوتر     
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ route('setting.createLogo') }}"
                                                class="block text-gray-700 py-2 text-md">
                                                لوگوی فوتر     
                                            </a>
                                        </li>
                            ...
                            @if (Auth::user()->role[0]->title == 'ادمین')
                                <div class="pt-3">
                                    <h3 class="text-md font-semibold text-gray-800 mb-1.5">محصولات</h3>
                            ...
                            @if (Auth::user()->role[0]->title == 'ادمین')
                                <div class="pt-3">
                                   <h3 class="text-md font-semibold text-gray-800 mb-1.5">دسته ها</h3>
                            ...
                            @if (Auth::user()->role[0]->title == 'ادمین')
                                <div class="pt-3">
                                    <h3 class="text-md font-semibold text-gray-800 mb-1.5">تنظیمات سایت</h3>
                                    ...
                                    <ul class="pr-3.5">
                                        ...
                                        <li>
                                            <a href="{{ route('setting.createHeroBannerRight') }}"
                                                class="block text-gray-700 py-2 text-md">
                                                 ایجاد بنر سمت راست
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ route('setting.createHeroBannerLeft') }}"
                                                class="block text-gray-700 py-2 text-md">
                                                 ایجاد بنر سمت چپ
                                            </a>
                                        </li>
