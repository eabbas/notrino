...
<body>
    ...
    <div class="w-full flex flex-row">
        ...
        {{-- </div> --}}
        <!-- sidebAR DESKTOP - استایل عین موبایل -->
        <div class="hidden lg:block lg:w-[265px] bg-[#0D0E12] fixed z-50 right-0 top-0 h-dvh px-5 text-sm desktop-sidebar">
            <div class="w-full">
                <a href="{{ route('home') }}"
                    class="block w-full py-3 text-center font-bold text-2xl text-white border-b border-gray-700">
                    notrinoshop.com
                </a>
            </div>
            <div class="py-5 h-[90%] overflow-y-auto flex flex-col gap-3" style="scrollbar-width: none;">
                ...
                <div class="flex flex-row items-center gap-2.5 py-3 px-2 hover:bg-gray-800 rounded-lg transition-all duration-300">
                    ...
                    <a href="{{ route('home') }}" class="block w-full text-white py-1 text-base font-medium" target="_blank">
                        بازدید از سایت
                    </a>
                </div>
                ...
                <div class="flex flex-row items-center gap-2.5 py-3 px-2 hover:bg-gray-800 rounded-lg transition-all duration-300 mb-1">
                    <svg xmlns="http://www.w3.org/2000/svg" class="size-5" viewBox="0 0 512 512" fill="white">
                ...
                @if (Auth::user()->role[0]->title == 'ادمین')
                    ...
                    <div class="desktop-menu-item mb-2">
                        <div class="flex flex-row justify-between items-center py-2 mb-2 px-2 rounded-lg cursor-pointer transition-all duration-200 {{ Route::is('user.list', 'user.create_user') ? 'bg-gray-700' : 'hover:bg-gray-800' }}" onclick="toggleSubmenuDesktop(this)">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-5 fill-white transition-transform duration-300 {{ Route::is('user.list', 'user.create_user') ? 'rotate' : '' }}">
                                <path fill-rule="evenodd" d="M12.53 16.28a.75.75 0 0 1-1.06 0l-7.5-7.5a.75.75 0 0 1 1.06-1.06L12 14.69l6.97-6.97a.75.75 0 1 1 1.06 1.06l-7.5 7.5Z" clip-rule="evenodd" />
                            </svg>
                        </div>
                        <ul class="mobile-submenu pr-4 {{ Route::is('user.list', 'user.create_user') ? 'open' : '' }}">
                            <li class="flex flex-row items-center gap-2.5 mb-1 pr-6 rounded-lg transition-all duration-200 {{ Route::is('user.list') ? 'bg-gray-700' : 'hover:bg-gray-800' }}">
                                <span class="size-1.5 bg-white rounded-sm"></span>
                                <a href="{{ route('user.list') }}" class="text-white py-1 text-sm block w-full">مشاهده همه کاربران</a>
                            </li>
                            <li class="flex flex-row items-center gap-2.5 pr-6 rounded-lg transition-all duration-200 {{ Route::is('user.create_user') ? 'bg-gray-700' : 'hover:bg-gray-800' }}">
                                <span class="size-1.5 bg-white rounded-sm"></span>
                                <a href="{{ route('user.create_user') }}" class="text-white py-1 text-sm block w-full">ایجاد کاربر جدید</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <!-- فوتر -->
                    <div class="desktop-menu-item mb-2">
                        <div class="flex flex-row justify-between items-center py-2 mb-2 px-2 rounded-lg cursor-pointer transition-all duration-200 {{ Route::is('footer.footerCreate', 'express.expressCreate', 'setting.createDescription', 'setting.createLogo') ? 'bg-gray-700' : 'hover:bg-gray-800' }}" onclick="toggleSubmenuDesktop(this)">
                            <div class="flex flex-row items-center gap-2 flex-1">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-5 fill-white transition-transform duration-300 {{ Route::is('footer.footerCreate', 'express.expressCreate', 'setting.createDescription', 'setting.createLogo') ? 'rotate' : '' }}">
                                <path fill-rule="evenodd" d="M12.53 16.28a.75.75 0 0 1-1.06 0l-7.5-7.5a.75.75 0 0 1 1.06-1.06L12 14.69l6.97-6.97a.75.75 0 1 1 1.06 1.06l-7.5 7.5Z" clip-rule="evenodd" />
                            </svg>
                        </div>
                        <ul class="mobile-submenu pr-4 {{ Route::is('footer.footerCreate', 'express.expressCreate', 'setting.createDescription', 'setting.createLogo') ? 'open' : '' }}">
                            <li class="flex flex-row items-center gap-2.5 mb-1 pr-6 rounded-lg transition-all duration-200 {{ Route::is('footer.footerCreate') ? 'bg-gray-700' : 'hover:bg-gray-800' }}">
                                <span class="size-1.5 bg-white rounded-sm"></span>
                                <a href="{{ route('footer.footerCreate') }}" class="text-white py-1 text-sm block w-full">ایجاد ستون های فوتر</a>
                            </li>
                            <li class="flex flex-row items-center gap-2.5 mb-1 pr-6 rounded-lg transition-all duration-200 {{ Route::is('express.expressCreate') ? 'bg-gray-700' : 'hover:bg-gray-800' }}">
                                <span class="size-1.5 bg-white rounded-sm"></span>
                                <a href="{{ route('express.expressCreate') }}" class="text-white py-1 text-sm block w-full">ایجاد بنر های فوتر</a>
                            </li>
                            <li class="flex flex-row items-center gap-2.5 mb-1 pr-6 rounded-lg transition-all duration-200 {{ Route::is('setting.createDescription') ? 'bg-gray-700' : 'hover:bg-gray-800' }}">
                                <span class="size-1.5 bg-white rounded-sm"></span>
                                <a href="{{ route('setting.createDescription') }}" class="text-white py-1 text-sm block w-full">توضیحات فوتر</a>
                            </li>
                            <li class="flex flex-row items-center gap-2.5 pr-6 rounded-lg transition-all duration-200 {{ Route::is('setting.createLogo') ? 'bg-gray-700' : 'hover:bg-gray-800' }}">
                                <span class="size-1.5 bg-white rounded-sm"></span>
                                <a href="{{ route('setting.createLogo') }}" class="text-white py-1 text-sm block w-full">لوگوی فوتر</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <!-- محصولات -->
                    <div class="desktop-menu-item mb-2">
                        <div class="flex flex-row justify-between items-center py-2 mb-2 px-2 rounded-lg cursor-pointer transition-all duration-200 {{ Route::is('product.create', 'product.list') ? 'bg-gray-700' : 'hover:bg-gray-800' }}" onclick="toggleSubmenuDesktop(this)">
                            <div class="flex flex-row items-center gap-2 flex-1">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" fill="currentColor" class="size-5 fill-white">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-5 fill-white transition-transform duration-300 {{ Route::is('product.create', 'product.list') ? 'rotate' : '' }}">
                                <path fill-rule="evenodd" d="M12.53 16.28a.75.75 0 0 1-1.06 0l-7.5-7.5a.75.75 0 0 1 1.06-1.06L12 14.69l6.97-6.97a.75.75 0 1 1 1.06 1.06l-7.5 7.5Z" clip-rule="evenodd" />
                            </svg>
                        </div>
                        <ul class="mobile-submenu pr-4 {{ Route::is('product.create', 'product.list') ? 'open' : '' }}">
                            <li class="flex flex-row items-center gap-2.5 mb-1 pr-6 rounded-lg transition-all duration-200 {{ Route::is('product.create') ? 'bg-gray-700' : 'hover:bg-gray-800' }}">
                                <span class="size-1.5 bg-white rounded-sm"></span>
                                <a href="{{ route('product.create') }}" class="text-white py-1 text-sm block w-full">ایجاد محصولات</a>
                            </li>
                            <li class="flex flex-row items-center gap-2.5 pr-6 rounded-lg transition-all duration-200 {{ Route::is('product.list') ? 'bg-gray-700' : 'hover:bg-gray-800' }}">
                                <span class="size-1.5 bg-white rounded-sm"></span>
                                <a href="{{ route('product.list') }}" class="text-white py-1 text-sm block w-full">لیست محصولات</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <!-- دسته ها -->
                    <div class="desktop-menu-item mb-2">
                        <div class="flex flex-row justify-between items-center py-2 mb-2 px-2 rounded-lg cursor-pointer transition-all duration-200 {{ Route::is('category.create', 'category.list') ? 'bg-gray-700' : 'hover:bg-gray-800' }}" onclick="toggleSubmenuDesktop(this)">
                            <div class="flex flex-row items-center gap-2 flex-1">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" fill="currentColor" class="size-5 fill-white">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-5 fill-white transition-transform duration-300 {{ Route::is('category.create', 'category.list') ? 'rotate' : '' }}">
                                <path fill-rule="evenodd" d="M12.53 16.28a.75.75 0 0 1-1.06 0l-7.5-7.5a.75.75 0 0 1 1.06-1.06L12 14.69l6.97-6.97a.75.75 0 1 1 1.06 1.06l-7.5 7.5Z" clip-rule="evenodd" />
                            </svg>
                        </div>
                        <ul class="mobile-submenu pr-4 {{ Route::is('category.create', 'category.list') ? 'open' : '' }}">
                            <li class="flex flex-row items-center gap-2.5 mb-1 pr-6 rounded-lg transition-all duration-200 {{ Route::is('category.create') ? 'bg-gray-700' : 'hover:bg-gray-800' }}">
                                <span class="size-1.5 bg-white rounded-sm"></span>
                                <a href="{{ route('category.create') }}" class="text-white py-1 text-sm block w-full">ایجاد دسته بندی</a>
                            </li>
                            <li class="flex flex-row items-center gap-2.5 pr-6 rounded-lg transition-all duration-200 {{ Route::is('category.list') ? 'bg-gray-700' : 'hover:bg-gray-800' }}">
                                <span class="size-1.5 bg-white rounded-sm"></span>
                                <a href="{{ route('category.list') }}" class="text-white py-1 text-sm block w-full">لیست دسته ها</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <!-- تنظیمات سایت -->
                    <div class="desktop-menu-item mb-2">
                        <div class="flex flex-row justify-between items-center py-2 mb-2 px-2 rounded-lg cursor-pointer transition-all duration-200 {{ Route::is('slider.sliderCreate', 'slider.list', 'setting.createHeroBannerRight', 'setting.createHeroBannerLeft', 'brand.brandCreate', 'brand.list') ? 'bg-gray-700' : 'hover:bg-gray-800' }}" onclick="toggleSubmenuDesktop(this)">
                            <div class="flex flex-row items-center gap-2 flex-1">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-5 fill-white transition-transform duration-300 {{ Route::is('slider.sliderCreate', 'slider.list', 'setting.createHeroBannerRight', 'setting.createHeroBannerLeft', 'brand.brandCreate', 'brand.list') ? 'rotate' : '' }}">
                                <path fill-rule="evenodd" d="M12.53 16.28a.75.75 0 0 1-1.06 0l-7.5-7.5a.75.75 0 0 1 1.06-1.06L12 14.69l6.97-6.97a.75.75 0 1 1 1.06 1.06l-7.5 7.5Z" clip-rule="evenodd" />
                            </svg>
                        </div>
                        <ul class="mobile-submenu pr-4 {{ Route::is('slider.sliderCreate', 'slider.list', 'setting.createHeroBannerRight', 'setting.createHeroBannerLeft', 'brand.brandCreate', 'brand.list') ? 'open' : '' }}">
                            <li class="flex flex-row items-center gap-2.5 mb-1 pr-6 rounded-lg transition-all duration-200 {{ Route::is('slider.sliderCreate') ? 'bg-gray-700' : 'hover:bg-gray-800' }}">
                                <span class="size-1.5 bg-white rounded-sm"></span>
                                <a href="{{ route('slider.sliderCreate') }}" class="text-white py-1 text-sm block w-full">ایجاد اسلایدر</a>
                            </li>
                            <li class="flex flex-row items-center gap-2.5 mb-1 pr-6 rounded-lg transition-all duration-200 {{ Route::is('slider.list') ? 'bg-gray-700' : 'hover:bg-gray-800' }}">
                                <span class="size-1.5 bg-white rounded-sm"></span>
                                <a href="{{ route('slider.list') }}" class="text-white py-1 text-sm block w-full">لیست اسلایدر</a>
                            </li>
                            <li class="flex flex-row items-center gap-2.5 mb-1 pr-6 rounded-lg transition-all duration-200 {{ Route::is('setting.createHeroBannerRight') ? 'bg-gray-700' : 'hover:bg-gray-800' }}">
                                <span class="size-1.5 bg-white rounded-sm"></span>
                                <a href="{{ route('setting.createHeroBannerRight') }}" class="text-white py-1 text-sm block w-full">ایجاد بنر سمت راست</a>
                            </li>
                            <li class="flex flex-row items-center gap-2.5 mb-1 pr-6 rounded-lg transition-all duration-200 {{ Route::is('setting.createHeroBannerLeft') ? 'bg-gray-700' : 'hover:bg-gray-800' }}">
                                <span class="size-1.5 bg-white rounded-sm"></span>
                                <a href="{{ route('setting.createHeroBannerLeft') }}" class="text-white py-1 text-sm block w-full">ایجاد بنر سمت چپ</a>
                            </li>
                            <li class="flex flex-row items-center gap-2.5 mb-1 pr-6 rounded-lg transition-all duration-200 {{ Route::is('brand.brandCreate') ? 'bg-gray-700' : 'hover:bg-gray-800' }}">
                                <span class="size-1.5 bg-white rounded-sm"></span>
                                <a href="{{ route('brand.brandCreate') }}" class="text-white py-1 text-sm block w-full">ایجاد برند</a>
                            </li>
                            <li class="flex flex-row items-center gap-2.5 pr-6 rounded-lg transition-all duration-200 {{ Route::is('brand.list') ? 'bg-gray-700' : 'hover:bg-gray-800' }}">
                                <span class="size-1.5 bg-white rounded-sm"></span>
                                <a href="{{ route('brand.list') }}" class="text-white py-1 text-sm block w-full">لیست برند</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    {{-- تماس با ما --}}
                    <div class="desktop-menu-item mb-2">
                        <div class="flex flex-row justify-between items-center py-2 mb-2 px-2 rounded-lg cursor-pointer transition-all duration-200 {{ Route::is('contactUs.commentList') ? 'bg-gray-700' : 'hover:bg-gray-800' }}" onclick="toggleSubmenuDesktop(this)">
                            <div class="flex flex-row items-center gap-2 flex-1">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor" class="size-5 fill-white">
                                    <path d="M164.9 24.6c-7.7-18.6-28-28.5-47.4-23.2l-88 24C12.1 30.2 0 46 0 64C0 311.4 200.6 512 448 512c18 0 33.8-12.1 38.6-29.5l24-88c5.3-19.4-4.6-39.7-23.2-47.4l-96-40c-16.3-6.8-35.2-2.1-46.3 11.6L304.7 368C234.3 334.7 177.3 277.7 144 207.3L193.3 167c13.7-11.2 18.4-30 11.6-46.3l-40-96z"/>
                                </svg>
                                <span class="text-white font-bold">تماس با ما</span>
                            </div>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-5 fill-white transition-transform duration-300 {{ Route::is('contactUs.commentList') ? 'rotate' : '' }}">
                                <path fill-rule="evenodd" d="M12.53 16.28a.75.75 0 0 1-1.06 0l-7.5-7.5a.75.75 0 0 1 1.06-1.06L12 14.69l6.97-6.97a.75.75 0 1 1 1.06 1.06l-7.5 7.5Z" clip-rule="evenodd" />
                            </svg>
                        </div>
                        <ul class="mobile-submenu pr-4 {{ Route::is('contactUs.commentList') ? 'open' : '' }}">
                            <li class="flex flex-row items-center gap-2.5 mb-1 pr-6 rounded-lg transition-all duration-200 {{ Route::is('contactUs.commentList') ? 'bg-gray-700' : 'hover:bg-gray-800' }}">
                                <span class="size-1.5 bg-white rounded-sm"></span>
                                <a href="{{ route('contactUs.commentList') }}" class="text-white py-1 text-sm block w-full">لیست نظرات</a>
                            </li>
    ...
    <script>
        ...
        function toggleSubmenuDesktop(headerElement) {
    const currentSubmenu = headerElement.nextElementSibling;
    const currentArrow = headerElement.querySelector('svg:first-child');
    
    // پیدا کردن همه آیتم‌های منوی باز شده به جز آیتم فعلی
    const allSubmenus = document.querySelectorAll('.desktop-sidebar .mobile-submenu');
    const allArrows = document.querySelectorAll('.desktop-sidebar .desktop-menu-item > div > svg:first-child');
    
    // اگر منوی فعلی باز نیست
    if (!currentSubmenu.classList.contains('open')) {
        ...
        // اگر منوی فعلی باز بود، فقط بسته بشه
